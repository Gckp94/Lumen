...
class TestInitialMetricsWithAdjustment:
    ...
    def test_default_adjustment_params_values(self) -> None:
        """Verify default AdjustmentParams are 8% stop-loss and 5% efficiency."""
    ...
    def test_initial_metrics_should_use_adjustment_scenario(self) -> None:
        ...
        metrics should use the default stop-loss (8%) and efficiency (5%).
        """
        ...
        # Trade 1: 10% gain, 5% MAE < 8% stop -> stays 10%, adjusted = 10% - 5% = 5%
        # Trade 2: -5% loss, 12% MAE > 8% stop -> -8%, adjusted = -8% - 5% = -13%
        # Result: 1 winner (5%), 1 loser (-13%)
